...
void main(void)
{
	...
	const double filter_coeff[8] = {0.00875474, 0.04794887, 0.16402439, 0.27927199, 0.27927199, 0.16402439, 0.04794887, 0.00875474}; 
	int ctr = 0;
	...
	while (1)
	{
		...
		data_send[0] = 48 + (ans/1000);
		data_send[1] = 48 + (ans%1000/100);
		data_send[2] = 48 + (ans%100/10);
		data_send[3] = 48 + (ans%10);
